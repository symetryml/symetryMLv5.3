...
The functionality basically build various model each with differents input attributes using some heuristics. It then
compute a score for them using out of sample data and will keep the best one. The following table describe the
